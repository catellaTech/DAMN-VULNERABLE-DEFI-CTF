...
describe('[Challenge] Side entrance', function () {
    ...
    it('Exploit', async function () {
        ...
        const attackingFactory = await ethers.getContractFactory('Attack', attacker);
        this.attacking =  await attackingFactory.deploy(this.pool.address);

        await this.attacking.connect(attacker).Exploit(ETHER_IN_POOL);
    });
